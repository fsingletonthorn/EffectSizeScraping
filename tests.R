...
identical(extractTestStats(testTString)[[1]][[2]], testT)
identical(extractTestStats(testFString)[[2]][[2]], testF)
identical(extractTestStats(testTString)[[1]][[1]], str_remove_all(testT, "\\s"))
identical(extractTestStats(testFString)[[2]][[1]], str_remove_all(testF, "\\s"))
