...
#' @return A tibble contaitning all detected effect sizes in odds ratios, Hazard ratios, d and eta squared,  with columns identifying the type of statistic extracted, the reported effect size as reported in the text, an empty column for the degrees of freedom (for comparability with the other extractor functions), a column for reported p values, and the effect size value reported.
#' 
#' 
#' @examples
