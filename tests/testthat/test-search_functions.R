...
expect_identical(findN("a total of Fifty-one survey responses")[[2]][[1]], "51")
expect_identical(findN("a total of Fifty-one survey responses")[[2]][[1]], "51")
expect_identical(findN("123 completed surveys")[[2]][[1]], "123")
...
test_that("the sentence break works as expected", {
  expect_identical(findN("a total of 12 participants were involved. There were also some birds.")$string[[1]], "a total of 12 participants were involved")
}
)
...
test_that("CI extractor does not return True for NA", {
  expect_false(checkCIs(NA)$CIBinary)
  }
)          
